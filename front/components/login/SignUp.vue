<template>
  ...
  <form action="" method="post" class="space-y-3 mt-5">
      <div>
          ...
          <input type="text" id="username" class="bg-gray-50 border-2 text-gray-900 text-sm rounded-lg focus:drop-shadow-xl focus:border-blue-500 focus:border-2 focus:border-blue-500 block w-full p-2.5 !outline-none" placeholder="John" required>
      </div>
      <div>
      ...
      <div>
          ...
          <div class="flex">
              <input :type="password_type" id="retype-password" class="bg-gray-50 border-l-2 border-y-2 text-gray-900 text-sm rounded-l-xl focus:drop-shadow-xl focus:border-blue-500 focus:border-2 focus:border-blue-500 w-full p-2.5 !outline-none" placeholder="•••••••••" required>
      ...
      <div>
          <input type="submit" value="Sign Up" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-light rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none w-full cursor-pointer">
      </div>
  </form>
  <div>
