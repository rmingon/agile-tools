<template>
    ...
    <form action="" method="post" class="space-y-3 mt-5">
        ...
        <div>
            <input @click="submit" type="submit" value="Sign Up" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-light rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none w-full cursor-pointer">
        </div>
    </form>
    <div>
        Don't have account ?
